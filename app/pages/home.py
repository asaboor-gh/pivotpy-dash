...
include_ = dcc.Input(id = 'include_field',value=None,type="text",debounce=True)
exclude_ = dcc.Input(id = 'exclude_field',value=None,type="text",debounce=True)
selection_ = dcc.Dropdown(id='file_radio',options=[{'label':i,'value':i} for i in ['Files','Folders','Both']],value='Both',clearable=False)
depth_ = dcc.Dropdown(id='dirs_depth',options=[{'label':str(i),'value':i} for i in [1,2,3,4,5,'Max']],value=1,clearable=False)
